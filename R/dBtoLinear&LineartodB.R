...
#' @param factor Character. Specify in what factor the functoin should use to convert your data. \code{SPL} (Sound Pressute Level) for amplitude like data (factor \code{20}) or \code{IL} (Intensity Level) for power like (fator \code{10}). (By default \code{IL})
